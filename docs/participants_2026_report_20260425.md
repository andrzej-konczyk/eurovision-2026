...
## Withdrawn / non-participating countries

### Iceland
- **In Kaggle dataset 2026:** no
- **Reason:** Withdrew — joined boycott of Israeli participation.

### Ireland
- **In Kaggle dataset 2026:** no
- **Reason:** Boycott — withdrew in protest of Israeli participation.
...
### North Macedonia
- **In Kaggle dataset 2026:** no
- **Reason:** Confirmed non-participation prior to participant announcement.
...
### Spain
- **In Kaggle dataset 2026:** no
- **Reason:** Boycott — refused to participate due to Israeli entry (alongside Ireland, Iceland, Netherlands, Slovenia). First time Spain (Big 5) missed since Italy rejoined in 2011.
...
| Azerbaijan | Jiva | Just Go | SF2 | ok |
| Belgium | Essyla | Dancing on the Ice | SF1 | ok |
| Bulgaria | Dara | Bangaranga | SF2 | ok |
| Croatia | Lelek | Andromeda | SF1 | ok |
...
| Serbia | Lavina | Kraj mene | SF1 | ok |
